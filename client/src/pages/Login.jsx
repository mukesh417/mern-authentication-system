...
//   const [isSubmitting, setIsSubmitting] = useState(false); // For btn to be disabled after submitting
  ...
  const onSubmitHandler = async (e) => {
    ...
    //   setIsSubmitting(true); // btn disabled
      ...
      axios.defaults.withCredentials = true; // It will send the cookie to the backend for authentication
  ...
  return (
    <div className="flex  items-center justify-center min-h-screen px-6 sm:px-0 bg-gradient-to-br from-blue-200 to-purple-400 ">
      ...
      <div className="bg-slate-900 p-10 rounded-lg shadow-lg w-full sm:w-96 text-indigo-300 text-sm">
        ...
        {state === 'Sign Up' ? ( <p className="mt-4 text-xs text-center text-gray-400">
